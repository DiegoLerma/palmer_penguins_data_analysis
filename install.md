# Data Analysis guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `palmer_penguin_project/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `palmer_penguin_project` folder and use the modules inside your notebooks :
...
```python
from palmer_penguin_project.utils.paths import data_dir
data_dir()
```
